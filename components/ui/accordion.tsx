...
function AccordionTrigger({
  ...
  const isChallengeChevron = className?.includes('challenge-chevron');
    ...
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          ...
          !isChallengeChevron && "justify-between", // Only add justify-between if NOT the challenge-chevron  className
        )}
        {...props}
      >
        {children}
